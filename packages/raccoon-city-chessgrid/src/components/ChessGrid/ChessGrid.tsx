...
import {GET_GROUPED_FLATS_CHESSGRID, GetGroupedFlatsBySectionQuery} from '../../core/graphql/queries/houseQuery';
    ...
    return (
        <React.Fragment>
            ...
            <Container maxWidth={false}>
                <ChessGridFiltersDrawer filterShown={filterShown} setShownFilters={setShownFilters} dispatchFn={dispatch}
